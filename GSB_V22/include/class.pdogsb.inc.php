...
class PdoGsb{   		
      	...
      	private static $bdd='dbname=gdb_frais';   		
      	private static $user='sammy' ;    		
 ...
 */
	...
	public function getModePaiement(){
		$req = "SELECT ModePaiement.id as idpaiement, ModePaiement.modePaiement as paiement FROM ModePaiement";
		$res = PdoGsb::$monPdo->query($req);
